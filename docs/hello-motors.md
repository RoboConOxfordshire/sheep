...
:::tip
Motor power is automatically scaled for the 3-6V motors included in the kit, if you are sourcing your own motors then see https://robocon.uk/docs/motors.html for how to allow faster speeds.
:::
